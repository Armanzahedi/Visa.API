...
namespace Visa.Infrastructure.Migrations
{
    ...
    [Migration("20201021090504_Added-static-content-entitiies2")]
    partial class Addedstaticcontententitiies2
    {
            ...
            modelBuilder.Entity("Visa.Core.Models.StaticContentDetail", b =>
                {
                    ...
                    b.Property<string>("StaticContentTypeId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("StaticContentTypeId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StaticContentTypeId1");
            ...
            modelBuilder.Entity("Visa.Core.Models.StaticContentDetail", b =>
                {
                    b.HasOne("Visa.Core.Models.StaticContentType", "StaticContentType")
                        ...
                        .HasForeignKey("StaticContentTypeId1");
                });
